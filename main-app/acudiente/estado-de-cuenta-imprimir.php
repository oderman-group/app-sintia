...
<head>
    ...
    <title>Estado de Cuenta - <?= htmlspecialchars($datosUsuarioActual['uss_nombre'] ?? 'Acudiente') ?></title>
    <style>
        @media print {
...
<body>
    ...
    <div class="info-acudiente">
        ...
        <table>
            ...
            <tr>
                <td>Email:</td>
                <td><?= htmlspecialchars($datosUsuarioActual['uss_email'] ?? 'N/A') ?></td>
            </tr>
        </table>
    </div>
            ...
            while($resultado = mysqli_fetch_array($consultaFacturas, MYSQLI_BOTH)){
                ...
                switch($estado) {
                    ...
                    case 'ANULADA':
                        ...
                        break;
                    default:
                        $estadoTexto = $estado ?: 'No definido';
                        $estadoClass = '';
                }
            ?>
            <tr>
