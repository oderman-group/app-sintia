...
if (!empty($_FILES['firmaDigital']['name']) && ($datosUsuarioActual['uss_tipo'] != TIPO_ESTUDIANTE || $config['conf_id_institucion'] != ICOLVEN)) {
...
if (!empty($_FILES['fotoPerfil']['name']) && ($datosUsuarioActual['uss_tipo'] != TIPO_ESTUDIANTE || $config['conf_id_institucion'] != ICOLVEN)) {
