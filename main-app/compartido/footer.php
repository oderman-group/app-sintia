...
<?php } ?>
<!-- boton de chat -->
<?php if(($idPaginaInterna != 'DT0209' || $idPaginaInterna != 'DC0148') && ($datosUsuarioActual['uss_tipo'] == TIPO_DEV || (($datosUsuarioActual['uss_tipo'] == TIPO_DOCENTE || $datosUsuarioActual['uss_tipo'] == TIPO_DIRECTIVO) && $_SESSION["datosUnicosInstitucion"]['ins_id_plan'] == Plataforma::PLAN_PREMIUM && Modulos::verificarModulosDeInstitucion(NULL, Modulos::MODULO_CHAT_ATENCION)))){ ?>
