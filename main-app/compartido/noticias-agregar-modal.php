...
<div class="card-body " id="bar-parent6">
    <form class="form-horizontal" action="../compartido/noticias-guardar.php" method="post"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea name="contenido" id="editor1" class="form-control" rows="5"
                    style="margin-top: 0px; margin-bottom: 0px; height: 100px; resize: none;" required></textarea>
            </div>
        </div>

        <div class="form-group row">
            <label class="col-sm-2 control-label">Descripción final
                <button type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="right"
                    title="Este texto se verá reflejado al final de la publicación, después de la imagen o video (si has incluido uno de estos elementos en la publicación)."><i
                        class="fa fa-info"></i></button>
            </label>
            <div class="col-sm-10">
                <textarea name="contenidoPie" id="editor2" class="form-control" rows="3"
                    style="margin-top: 0px; margin-bottom: 0px; height: 70px; resize: none;" required></textarea>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="file" name="imagen" class="form-control" onChange="validarPesoArchivo(this)"
                    accept=".png, .jpg, .jpeg">
            </div>
        </div>
            ...
            <div class="col-sm-10">
                ...
                <select class="form-control  select2" style="width: 100%" name="categoriaGeneral" required>
                    ...
                    while ($datos = mysqli_fetch_array($datosConsulta, MYSQLI_BOTH)) {
                        ?>
                        <option value="<?= $datos['gcat_id']; ?>" <?php if ($datos['gcat_id'] == 15)
                              echo "selected"; ?>>
                            <?= $datos['gcat_nombre'] ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
        ...
        <?php if ($datosUsuarioActual['uss_tipo'] == TIPO_DEV) { ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="col-sm-2 card-head" data-toggle="tooltip"
                        title="Notificará la noticia en tiempo real a todos los usuarios conectados "
                        style=" border-bottom: 0px rgba(0, 0, 0, 0.2);">
                        <header>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select style="width: 100%" id="multiple" class="form-control select2-multiple" multiple
                    name="cursos[]">
                    <?php
