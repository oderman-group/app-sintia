							...
							<li <?php agregarClass(MENU_PADRE,["DT0001","DT0062","DT0017","DT0020","DT0032","DT0121","DT0195","DT0196","DT0197"]) ?> data-step="2" data-intro="<b>Gestión Académica:</b> Aquí podrás gestionar las opciones académicas: Matriculas, cursos, áreas, asignaturas, cargas académicas, etc." data-position='left'>
	                            ...
	                            <ul class="sub-menu" <?php agregarClass(SUB_MENU,["DT0001","DT0062","DT0017","DT0020","DT0032","DT0121","DT0195","DT0196","DT0197"]) ?> >
									...
									?>
	                                	<li <?php agregarClass(MENU,["DT0001"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_MATRICULAS, "estudiantes.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[209][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php
										}
									
										if(Modulos::validarSubRol(['DT0062'])){
									?>
										<li <?php agregarClass(MENU,["DT0062"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_CURSO_Y_GRADOS, "cursos.php", MENU) ?>class="nav-link "> <span class="title"><?=$frases[5][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php
										}
									
										if(Modulos::validarSubRol(['DT0195'])){
									?>
										<li <?php agregarClass(MENU,["DT0195","DT0196","DT0197"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_CURSO_Y_GRADOS, "grupos.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[254][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php
										}
									
										if(Modulos::validarSubRol(['DT0017'])){
									?>
										<li <?php agregarClass(MENU,["DT0017"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_AREAS, "areas.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[93][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php
										}
									
										if(Modulos::validarSubRol(['DT0020'])){
									?>
										<li <?php agregarClass(MENU,["DT0020"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_ASIGNATURAS, "asignaturas.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[73][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php
										}
									
										if(Modulos::validarSubRol(['DT0032'])){
									?>
										<li <?php agregarClass(MENU,["DT0032"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_CARGAS_ACADEMICAS, "cargas.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[12][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php
										}
										
											if (
												Modulos::validarSubRol(['DT0121']) &&
												Modulos::verificarModulosDeInstitucion(Modulos::MODULO_RESERVA_CUPO)
											) {
									?>
							...
							//MÓDULO INSCRIPCIONES Y ADMISIONES
								if (
									...
									Modulos::verificarModulosDeInstitucion(Modulos::MODULO_INSCRIPCIONES)
								) {
							?>
								<li <?php agregarClass(MENU_PADRE,["DT0102", "DT0014"]) ?> data-step="3" data-intro="<b>Admisiones e inscripciones:</b> Módulo para gestionar las inscripciones de nuevos estudiantes a tus institución." data-position='bottom'>
									...
									<ul class="sub-menu" <?php agregarClass(SUB_MENU,["DT0102", "DT0014"]) ?>>
										...
										?>
											<li <?php agregarClass(MENU,["DT0102"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_INSCRIPCIONES, "inscripciones.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[392][$datosUsuarioActual['uss_idioma']];?></span></a></li>
										<?php }?>

										<?php
											if(Modulos::validarSubRol(["DT0014"])){
										?>
											<li <?php agregarClass(MENU,["DT0014"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_INSCRIPCIONES, "configuracion-admisiones.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[17][$datosUsuarioActual['uss_idioma']];?></span></a></li>
										<?php }?>
									</ul>
								</li>
							<?php }?>
							...
							//MÓDULO FINANCIERO
								if (
									...
									Modulos::verificarModulosDeInstitucion(Modulos::MODULO_FINANCIERO)
								) {
							?>
								<li <?php agregarClass(MENU_PADRE,["DT0104", "DT0106", "DT0128", "DT0105", "DT0258", "DT0259", "DT0261", "DT0264", "DT0265", "DT0267", "DT0273", "DT0275", "DT0276", "DT0278", "DT0294", "DT0295", "DT0297"]) ?> data-step="4" data-intro="<b>G. Financiera:</b> Maneja las finanzas de tu institución desde aqui. Facturas, cobros, abonos." data-position='bottom' data-scrollTo='tooltip'>
									...
									<ul class="sub-menu" <?php agregarClass(SUB_MENU,["DT0104", "DT0106", "DT0128", "DT0105", "DT0258", "DT0259", "DT0261", "DT0264", "DT0265", "DT0267", "DT0273", "DT0275", "DT0276", "DT0277", "DT0278", "DT0279", "DT0280", "DT0281", "DT0294", "DT0295", "DT0297"]) ?>>
										...
										?>
											<li <?php agregarClass(MENU,["DT0104", "DT0106", "DT0128", "DT0105"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_TRANSACCIONES, "movimientos.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[95][$datosUsuarioActual['uss_idioma']];?></span></a></li>
										<?php 
											}
										...
										?>
											<li <?php agregarClass(MENU,["DT0264", "DT0265", "DT0267"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_TRANSACCIONES, "abonos.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[413][$datosUsuarioActual['uss_idioma']];?></span></a></li>
										<?php 
											}
											if(Modulos::validarSubRol(["DT0258"])){ 
										?>
											<li <?php agregarClass(MENU,["DT0258", "DT0259", "DT0261"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_TRANSACCIONES, "items.php", MENU) ?> class="nav-link "> <span class="title">Items</span></a></li>
										<?php 
											}
											if(Modulos::validarSubRol(["DT0294"])){ 
										?>
											<li <?php agregarClass(MENU,["DT0294", "DT0295", "DT0297"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_IMPUESTOS, "impuestos.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[425][$datosUsuarioActual['uss_idioma']];?></span></a></li>
										<?php
											}
										...
										?>
											<li <?php agregarClass(MENU,["DT0305"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_REPORTES_FINANCIEROS_GRAFICOS, "moviminetos-reportes-graficos.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[427][$datosUsuarioActual['uss_idioma']];?></span></a></li>
										<?php }?>
									</ul>
								</li>
							<?php }?>
							...
							?>
								<li class="nav-item" data-step="5" data-intro="<b>Gestión de comportamiento:</b> Gestiona las categorias y tipifica las faltas de comportamiento. Crea reportes y obten informes disciplinarios." data-position='bottom' data-scrollTo='tooltip'>
									...
									<ul class="sub-menu">
										...
										?>
											<li class="nav-item"><a <?php validarModuloMenu(Modulos::MODULO_FALTAS_Y_CATEGORIAS, "disciplina-categorias.php", MENU) ?> class="nav-link"> <span class="title"><?=$frases[222][$datosUsuarioActual['uss_idioma']];?></span></a></li>
										<?php
											}
											
											if(Modulos::validarSubRol(["DT0066"])){
										?>
											<li class="nav-item"><a <?php validarModuloMenu(Modulos::MODULO_FALTAS_Y_CATEGORIAS, "disciplina-faltas.php", MENU) ?> class="nav-link"> <span class="title"><?=$frases[248][$datosUsuarioActual['uss_idioma']];?></span></a></li>
										<?php
											}
										?>
									</ul>
							...
							//MÓDULO ADMINISTRTIVO
								if(
									...
									Modulos::verificarModulosDeInstitucion(Modulos::MODULO_ADMINISTRATIVO)
								) {
							?>
							<li <?php agregarClass(MENU_PADRE,["DT0011","DT0122","DT0124","DT0126","DT0204","DT0205"]) ?> data-step="6" data-intro="<b>Gestión administrativa:</b> Gestiona tus tipos de usuarios, asigna roles y permisos. También puedes revisar las solicitudes desbloqueo." data-position='bottom' data-scrollTo='tooltip'>
	                            ...
	                            <ul class="sub-menu" <?php agregarClass(SUB_MENU,["DT0011","DT0122","DT0124","DT0126","DT0204","DT0205"])?>>
									...
									?>
										<li <?php agregarClass(MENU,["DT0126","DT0124"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_USUARIOS, "usuarios.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[75][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php
										}
										
										if(Modulos::validarSubRol(["DT0122"])){
									?>
										<li <?php agregarClass(MENU,["DT0122"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_USUARIOS, "solicitudes.php", MENU) ?> class="nav-link "> <span class="title">Solicitud desbloqueo</span><span id="contador_solicitudes" class="badge headerBadgeColor2 hidden">0</span></a></li>
									<?php
										}
										
										if(Modulos::validarSubRol(["DT0011"])){
									?>
										<li <?php agregarClass(MENU,["DT0011"]) ?>><a <?php validarModuloMenu(Modulos::MODULO_USUARIOS, "galeria.php", MENU) ?> class="nav-link "> <span class="title"><?=$frases[223][$datosUsuarioActual['uss_idioma']];?></span></a></li>
									<?php
										}
										
										if (
											Modulos::validarSubRol(["DT0204"]) &&
											Modulos::verificarModulosDeInstitucion(Modulos::MODULO_SUB_ROLES)
										) {
									?>
									...
									if (
											...
											Modulos::verificarModulosDeInstitucion(Modulos::MODULO_TIPOS_NOTIFICACIONES)
										) {
									?>
										<li <?php agregarClass(MENU,["DT0349","DT0350"]) ?>>
											<a 
												<?php validarModuloMenu(Modulos::MODULO_TIPOS_NOTIFICACIONES, "tipos-notificaciones-listar.php", MENU) ?> 
												class="nav-link"
											> 
							...
							//MÓDULO CUESTIONARIO EVALUATIVO
								if(
									...
									Modulos::verificarModulosDeInstitucion(Modulos::MODULO_CUESTIONARIOS)
								) {
							?>
							...
							?>
								<li class="nav-item">
									<a <?php validarModuloMenu(Modulos::MODULO_MERCADEO, "#", MENU_PADRE) ?> class="nav-link nav-toggle"> 
										<div class="menu-icon icon-marketing">
							...
							<li class="nav-item" data-step="8" data-intro="<b>Configuración:</b> Esta es una de las partes más importantes porque puedes definir los comportamientos que tendrá la plataforma en varios aspectos. ¡Exploralo!" data-position='bottom' data-scrollTo='tooltip'>
	                            ...
	                            <ul class="sub-menu">
									<?php
									if (Modulos::verificarModulosDeInstitucion(Modulos::MODULO_CONFIGURACION)) {
							...
							//INFORMES
								if (
									...
									Modulos::verificarModulosDeInstitucion(Modulos::MODULO_GENERAL)
								) {
							?>
