...
<head>
    ...
    <meta name="description" content="Guía completa paso a paso para usuarios directivos de SINTIA. Aprende a configurar y usar la plataforma educativa.">
    <meta name="keywords" content="SINTIA, guía, tutorial, directivos, configuración, plataforma educativa">
    <link rel="shortcut icon" href="../../config-general/assets-login-2023/img/logo.png" type="image/x-icon">
    <title>Guía para Directivos - SINTIA | Tutorial Completo</title>
...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1><i class="fas fa-rocket"></i> Guía Completa para Directivos</h1>
            <p>Bienvenido a la guía paso a paso de SINTIA. Sigue estos pasos para configurar tu institución y comenzar a usar todas las funcionalidades de la plataforma.</p>
            <div class="hero-badges">
                <span class="badge-custom"><i class="fas fa-clock"></i> Tiempo estimado: 30 min</span>
    ...
    <div class="main-container">
        ...
        <aside class="toc-sidebar">
            ...
            <ul class="toc-nav">
                ...
                <li><a href="#paso-1" class="toc-link"><i class="fas fa-circle"></i> Paso 1: Configuración del Sistema</a></li>
                <li><a href="#paso-2" class="toc-link"><i class="fas fa-circle"></i> Paso 2: Crear Usuarios</a></li>
                <li><a href="#paso-3" class="toc-link"><i class="fas fa-circle"></i> Paso 3: Información de la Institución</a></li>
                <li><a href="#paso-4" class="toc-link"><i class="fas fa-circle"></i> Paso 4: Gestión de Cursos</a></li>
                <li><a href="#paso-5" class="toc-link"><i class="fas fa-circle"></i> Paso 5: Configurar Áreas</a></li>
                <li><a href="#paso-6" class="toc-link"><i class="fas fa-circle"></i> Paso 6: Definir Asignaturas</a></li>
                <li><a href="#paso-7" class="toc-link"><i class="fas fa-circle"></i> Paso 7: Crear Cargas Académicas</a></li>
                <li><a href="#paso-8" class="toc-link"><i class="fas fa-circle"></i> Paso 8: Gestionar Matrículas</a></li>
        ...
        <main class="content-area">
            ...
            <section id="introduccion" class="content-section">
                ...
                <div class="section-description">
                    <p>Esta guía te llevará paso a paso por la configuración inicial de SINTIA para tu institución educativa. Cada paso está diseñado para ser claro, directo y fácil de seguir.</p>
                    <p><strong>¿Qué necesitas antes de empezar?</strong></p>
                    <ul style="margin-left: 1.5rem; margin-top: 1rem;">
                        <li>Acceso a tu cuenta de administrador en SINTIA</li>
                        <li>Información básica de tu institución</li>
                        <li>Datos de los usuarios que crearás (directivos y docentes)</li>
                        <li>Lista de cursos, áreas y asignaturas</li>
                        <li>Información de estudiantes (puede ser posterior)</li>
                    </ul>
                </div>
            ...
            <section id="paso-1" class="content-section">
                <div class="section-header">
                    ...
                    <div class="section-title-group">
                        <h2>Paso 1: Configuración del Sistema</h2>
                ...
                <div class="section-path">
                    <i class="fas fa-map-marker-alt"></i> Menú principal → Configuración → del sistema
                </div>

                <!-- 
                    INSTRUCCIONES PARA AGREGAR FOTOS:
                    Reemplaza las URLs de ejemplo con las rutas reales de tus imágenes.
                    Puedes usar rutas relativas como "files/images/guia/paso-1-1.jpg" o URLs absolutas.
                    Agrega más elementos <div class="image-item">...</div> para múltiples imágenes.
                -->
                <div class="media-section">
                    <h4><i class="fas fa-images"></i> Capturas de Pantalla</h4>
                    <div class="image-gallery">
                        <!-- Ejemplo de imagen - reemplazar con imágenes reales -->
                        <div class="image-item">
                            <img src="https://via.placeholder.com/400x300/667eea/ffffff?text=Configuración+Sistema" alt="Configuración del Sistema">
                            <div class="image-caption">Vista general de configuración</div>
                        </div>
                        <!-- Agrega más imágenes aquí copiando el bloque anterior -->
                    </div>
                </div>

                <!-- 
                    INSTRUCCIONES PARA AGREGAR VIDEO:
                    Descomenta el bloque siguiente y reemplaza VIDEO_URL con la URL del video.
                    Para YouTube: https://www.youtube.com/embed/VIDEO_ID
                    Para Vimeo: https://player.vimeo.com/video/VIDEO_ID
                -->
                <!--
                <div class="media-section">
                    <h4><i class="fas fa-video"></i> Video Tutorial de este Paso</h4>
                    <div class="video-wrapper">
                        <iframe src="VIDEO_URL_AQUI" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
                -->
            </section>
            ...
            <section id="paso-2" class="content-section">
                ...
                <div class="section-path">
                    <i class="fas fa-map-marker-alt"></i> Menú principal → G. Administrativa → Usuarios → Agregar nuevo
                </div>

                <!-- 
                    INSTRUCCIONES PARA AGREGAR FOTOS:
                    Descomenta el bloque siguiente y reemplaza las URLs con las rutas de tus imágenes.
                    Puedes usar rutas relativas como "files/images/guia/paso-2-1.jpg" o URLs absolutas.
                -->
                <!--
                <div class="media-section">
                    <h4><i class="fas fa-images"></i> Capturas de Pantalla</h4>
                    <div class="image-gallery">
                        ...
                        <div class="image-item">
                            <img src="RUTA_IMAGEN_2.jpg" alt="Descripción de la imagen 2">
                            <div class="image-caption">Otra descripción</div>
                        </div>
                    </div>
                </div>
                -->
                ...
                <!-- 
                    INSTRUCCIONES PARA AGREGAR VIDEO:
                    Descomenta el bloque siguiente y reemplaza VIDEO_URL con la URL del video de YouTube o Vimeo.
                    Para YouTube: https://www.youtube.com/embed/VIDEO_ID
                    Para Vimeo: https://player.vimeo.com/video/VIDEO_ID
                -->
                <!--
            ...
            <section id="paso-3" class="content-section">
                <div class="section-header">
                    ...
                    <div class="section-title-group">
                        <h2>Paso 3: Información de la Institución</h2>
                        <span class="section-badge">Esencial</span>
                    </div>
                </div>
                <div class="section-description">
                ...
                <div class="section-path">
                    <i class="fas fa-map-marker-alt"></i> Menú principal → Configuración → de la Institución
                </div>
                <!-- Agregar fotos/videos aquí usando la misma estructura que en Paso 1 y Paso 2 -->
            </section>
            ...
            <section id="paso-4" class="content-section">
                <div class="section-header">
                    ...
                    <div class="section-title-group">
                        <h2>Paso 4: Gestión de Cursos</h2>
                    </div>
                </div>
                <div class="section-description">
                ...
                <div class="section-path">
                    <i class="fas fa-map-marker-alt"></i> Menú principal → G. Académica → Cursos → Agregar nuevo
                </div>
            </section>
            ...
            <section id="paso-5" class="content-section">
                ...
                <div class="section-path">
                    <i class="fas fa-map-marker-alt"></i> Menú principal → G. Académica → Áreas → Agregar nuevo
                </div>
            </section>
            ...
            <section id="paso-6" class="content-section">
                <div class="section-header">
                    ...
                    <div class="section-title-group">
                        <h2>Paso 6: Definir Asignaturas</h2>
                    </div>
                </div>
                <div class="section-description">
                ...
                <div class="section-path">
                    <i class="fas fa-map-marker-alt"></i> Menú principal → G. Académica → Asignaturas → Agregar nuevo
                </div>
            </section>
            ...
            <section id="paso-7" class="content-section">
                <div class="section-header">
                    ...
                    <div class="section-title-group">
                        <h2>Paso 7: Crear Cargas Académicas</h2>
                        <span class="section-badge">Crítico</span>
                    </div>
                </div>
                <div class="section-description">
                ...
                <div class="section-path">
                    <i class="fas fa-map-marker-alt"></i> Menú principal → G. Académica → Cargas académicas → Agregar nuevo
                </div>
            </section>
            ...
            <section id="paso-8" class="content-section">
                ...
                <div class="section-path">
                    <i class="fas fa-map-marker-alt"></i> Menú principal → G. Académica → Matrículas → Agregar nuevo | Importar excel
                </div>
            </section>
