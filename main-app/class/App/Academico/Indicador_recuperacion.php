...
class Indicador_recuperacion extends BDT_Tablas implements BDT_JoinImplements
{

    public static $schema    = BD_ACADEMICA;
    public static $tableName = 'academico_indicadores_recuperacion';
    public  static $tableAs   = 'indr';
