...
class Vista_historial_calificaciones extends BDT_Tablas
{
    ...
    public static $tableName = 'vista_historial_calificaciones';
    ...
    public static function agruparDatos(array $datos)
    {
        try {
            ...
            //Calculamos pormedio total de los registros
