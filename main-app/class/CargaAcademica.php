...
class CargaAcademica {
    ...
    **/
    ...
    )
    {
        ...
        LEFT JOIN ".BD_ACADEMICA.".academico_indicadores_inclusion aii ON aii.aii_id_indicador = ind.ind_id AND aii.aii_id_estudiante = bol.bol_estudiante AND aii.aii_institucion=am.institucion AND aii.year= am.year
