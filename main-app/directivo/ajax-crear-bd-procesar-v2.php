...
try {
    ...
    $mensajeUsuario = "Error en el proceso de creación:\n\n";
    ...
    if (preg_match('/Duplicate entry/i', $errorMessage)) {
        $mensajeUsuario .= "\n\n💡 Sugerencia: Ya existe un registro con estos valores. Verifica si el año ya fue creado anteriormente o si hay datos duplicados en la tabla " . $tabla . ".";
    }
    
    $finalResponse['success'] = false;
    $finalResponse['message'] = $mensajeUsuario;
