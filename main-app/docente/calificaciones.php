...
/* ========================================
   CORRECCIÓN SELECTS EN MODAL ACTIVIDAD
   ======================================== */

#modalAgregarActividad select.form-control,
#modalAgregarActividad .form-control[name="indicador"] {
    cursor: pointer;
...
#modalAgregarActividad select.form-control::-ms-expand {
    display: none;
}

#modalAgregarActividad select.form-control option {
    padding: 10px;
    font-size: 0.95rem;
}
</style>
